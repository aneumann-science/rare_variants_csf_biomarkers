...
save(tau_pc_meta_results.data, file = "results/lof/diag/tau_pc_meta_results.Rdata")
...
save(ab_pc_meta_results.data, file = "results/lof/diag/ab_pc_meta_results.Rdata")
...
save(nfl_pc_meta_results.data, file = "results/lof/diag/nfl_pc_meta_results.Rdata")
...
save(ykl40_pc_meta_results.data, file = "results/lof/diag/ykl40_pc_meta_results.Rdata")
...
save(ng_pc_meta_results.data, file = "results/lof/diag/ng_pc_meta_results.Rdata")
