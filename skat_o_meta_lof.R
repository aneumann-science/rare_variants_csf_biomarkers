...
#phenotype_adni <- mmse_adni.data
#phenotype_name_adni <- "MMSE"
#phenotype_emif <- mmse_emif.data
#phenotype_name_emif <-  "Baseline_MMSE"
#covariates_adni <- mmse_cov_adni.data
#covariates_emif <- mmse_cov_emif.data
#gene <- genes_adni[[1]]
  ...
  tryCatch(
    {
      ...
      # Get covariate names
      covariate_names_adni <- names(covariates_adni[2:13])
      # Get SNP names
      ...
      # Get covariate names
      covariate_names_emif <- names(covariates_emif[2:7])
      # Get SNP names
